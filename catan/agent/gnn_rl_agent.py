...
from globals import SELECTED_GRAPH_MODEL, PLAYER_STATE_DIM, ACTION_DIM
...
class GNNRLAgent(Agent):
    ...
    def __init__(self, board: Board, player: Player):
        ...
        self.rl_agent = GNNRLModel(GNNRLAgent.shared_model, board)
    ...
    def save_model(self):
        ...
        print_debug(f"Model saved to {SELECTED_GRAPH_MODEL}")


class GNNRLModel:
    def __init__(self, model: GNNQNetwork, board: Board, gamma=0.99, epsilon=1.0, epsilon_decay=0.99995, batch_size=12, learning_rate=0.001):
        self.model = model
        self.gamma = gamma
